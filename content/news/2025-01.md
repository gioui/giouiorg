...
- content/doc/install: [WASM] clarify where to run gogio from. Folks were trying to run gogio in a random directory, not realizing that it acts within the current module (and fails if there is no current module. [c5b0178](https://git.sr.ht/~eliasnaur/giouiorg/commit/c5b0178)
- content/doc/install: add link to cross-compilation tips. Now that we have decent instructions on how to do this, it makes sense to make them easy to find. [f32f516](https://git.sr.ht/~eliasnaur/giouiorg/commit/f32f516)
- go.*: update to gio v0.8.0.  [396671b](https://git.sr.ht/~eliasnaur/giouiorg/commit/396671b)

Miles Alan:

- doc/showcase: Add Transito.  [a1f3d55](https://git.sr.ht/~eliasnaur/giouiorg/commit/a1f3d55)

Egon Elbre:

- go.mod: bump to gio@v0.7.1.  [fec3e7f](https://git.sr.ht/~eliasnaur/giouiorg/commit/fec3e7f)
